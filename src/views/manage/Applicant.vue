        ...
        <router-link :to="`/account/profile/${ applyUser.userId }`" v-for="applyUser in applyUsers" :key="applyUser.id" class="router">
          <div class="job-area">
            <div class="job-area-box">
              ...
              <p>{{ applyUser.user.userName }}</p>
            </div>
            <div class="job-area-box">
              <span>{{ applyUser.user.learningStartDate | moment("YYYY年 M月 D日") }}</span>
              <p>{{ applyUser.user.learningStartDate | moment("YYYY年 M月 D日") }}</p>
            </div>
            <div class="job-area-box">
              仮置き: {{ applyUser.user.userName }}
            </div>
          </div>
        </router-link>
      </div>
